  ...
  const benefits = [
    {
      ...
      title: "Harga Terbaik",
      description: "Kami menawarkan tarif penawaran paling kompetitif, transparan, dan jujur tanpa biaya tersembunyi untuk seluruh trip dan rental."
    },
    {
      ...
      description: "Seluruh pengemudi kami terlatih secara profesional, sangat ramah, serta menguasai rute jalanan berliku Flores dengan aman."
    },
    {
      ...
      description: "Setiap mobil dan kapal dirawat berkala secara rutin, bersih, wangi, ber-AC dingin, dan siap meluncur dalam kondisi prima."
    },
    {
      icon: <Zap className="w-6 h-6 text-brand-turquoise group-hover:scale-110 transition-transform duration-300" />,
      title: "Fast Response",
      description: "Layanan customer concierge kami sangat responsif, aktif melayani konsultasi rute, rental mobil, dan booking 24 jam penuh."
    },
    {
      ...
      description: "Pemandu wisata lokal berlisensi resmi yang komunikatif, andal, dan siap membantu mendokumentasikan momen indah liburan Anda."
    }
  ];
          ...
          <div className="lg:col-span-4 text-left space-y-6">
            ...
            <div className="pt-6 grid grid-cols-2 gap-6 border-t border-white/5">
              <div className="space-y-1">
                ...
                <span className="block text-[10px] font-bold font-sans text-slate-500 uppercase tracking-wider">Wisatawan Puas</span>
              </div>
              <div className="space-y-1">
                <span className="block font-sans font-extrabold text-4xl text-brand-gold tracking-tight">4.9/5</span>
                <span className="block text-[10px] font-bold font-sans text-slate-500 uppercase tracking-wider">Rating Ulasan</span>
              </div>
            </div>
          </div>
